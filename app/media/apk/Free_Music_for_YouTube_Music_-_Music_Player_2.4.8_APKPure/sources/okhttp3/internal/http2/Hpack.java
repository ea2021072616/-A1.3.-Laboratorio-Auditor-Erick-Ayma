...
public final class Hpack {
    ...
    static final class Reader {
        ...
        private int readByte() throws IOException {
            return this.source.i() & Constants.UNKNOWN;
        }
        ...
        f readByteString() throws IOException {
            ...
            if (z) {
                return f.a(Huffman.get().decode(this.source.g(readInt)));
            }
    ...
    static final class Writer {
        ...
        void writeInt(int i, int i2, int i3) {
            ...
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.i((i4 & Hpack.PREFIX_7_BITS) | 128);
                i4 >>>= 7;
            }
            this.out.i(i4);
        }
        ...
        void writeByteString(f fVar) throws IOException {
            if (this.useCompression && Huffman.get().encodedLength(fVar) < fVar.h()) {
                ...
                f q = cVar.q();
                writeInt(q.h(), Hpack.PREFIX_7_BITS, 128);
                this.out.b(q);
                return;
            }
            writeInt(fVar.h(), Hpack.PREFIX_7_BITS, 0);
            this.out.b(fVar);
        }
