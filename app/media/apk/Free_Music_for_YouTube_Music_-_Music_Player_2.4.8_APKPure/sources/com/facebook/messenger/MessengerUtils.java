...
public class MessengerUtils {
    ...
    public static MessengerThreadParams getMessengerThreadParamsForIntent(Intent intent) {
        ...
        if (categories != null && categories.contains(ORCA_THREAD_CATEGORY_20150314)) {
            Bundle b2 = c.b(intent);
            String string = b2.getString(EXTRA_THREAD_TOKEN_KEY);
            String string2 = b2.getString(EXTRA_METADATA);
            String string3 = b2.getString(EXTRA_PARTICIPANTS);
            boolean z = b2.getBoolean(EXTRA_IS_REPLY);
            boolean z2 = b2.getBoolean(EXTRA_IS_COMPOSE);
    ...
    public static void finishShareToMessenger(Activity activity, ShareToMessengerParams shareToMessengerParams) {
        ...
        if (categories == null) {
            ...
            if (categories.contains(ORCA_THREAD_CATEGORY_20150314)) {
                ...
                intent2.putExtra(EXTRA_THREAD_TOKEN_KEY, b2.getString(EXTRA_THREAD_TOKEN_KEY));
