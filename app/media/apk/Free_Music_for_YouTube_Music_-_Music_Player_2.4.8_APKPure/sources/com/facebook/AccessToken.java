...
public final class AccessToken implements Parcelable {
    ...
    public int hashCode() {
        return (((((this.applicationId == null ? 0 : this.applicationId.hashCode()) + ((((((((((((this.expires.hashCode() + 527) * 31) + this.permissions.hashCode()) * 31) + this.declinedPermissions.hashCode()) * 31) + this.token.hashCode()) * 31) + this.source.hashCode()) * 31) + this.lastRefresh.hashCode()) * 31)) * 31) + this.userId.hashCode()) * 31) + this.dataAccessExpirationTime.hashCode();
    }
