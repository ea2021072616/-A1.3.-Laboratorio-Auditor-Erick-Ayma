...
public class e {
    ...
    private static final String f1330c = e.class.getSimpleName();
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            switch (c2) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    this.f1331a = Integer.parseInt(entry.getValue());
                    break;
                case 7:
                    this.f1332b = Integer.parseInt(entry.getValue());
                    break;
                case '\b':
                ...
                case 11:
                    ...
                    try {
                        ...
                        for (b bVar : this.n) {
                            if (bVar.b()) {
                                cookieManager.setCookie(bVar.f1315a, bVar.f1316b + "=" + bVar.f1317c + ";Domain=" + bVar.f1315a + ";Expires=" + bVar.a() + ";path=/");
                            }
                        }
                        ...
                        Log.w(f1330c, "Failed to set cookie.", e);
                        break;
                    }
            }
        }
