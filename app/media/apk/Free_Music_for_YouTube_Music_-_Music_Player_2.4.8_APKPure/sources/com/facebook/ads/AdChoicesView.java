...
public class AdChoicesView extends RelativeLayout {
    ...
    private final NativeAd f1008b;

    /* renamed from: c  reason: collision with root package name */
    private final DisplayMetrics f1009c;
    private boolean d;
    private TextView e;
    private String f;
                    ...
                    if (AdChoicesView.this.d) {
                        ...
                        Animation animation2 = new Animation() { // from class: com.facebook.ads.AdChoicesView.3.1.1
                            ...
                            protected void applyTransformation(float f, Transformation transformation) {
                                int i = (int) (AnonymousClass3.this.f1015a + ((AnonymousClass3.this.f1016b - AnonymousClass3.this.f1015a) * f));
                                AdChoicesView.this.getLayoutParams().width = i;
                                AdChoicesView.this.requestLayout();
                                AdChoicesView.this.e.getLayoutParams().width = i - AnonymousClass3.this.f1016b;
    ...
    public AdChoicesView(Context context, final NativeAd nativeAd, boolean z) {
        ...
        this.d = false;
        this.f1007a = context;
        this.f1008b = nativeAd;
        this.f1009c = this.f1007a.getResources().getDisplayMetrics();
        if (this.f1008b.isAdLoaded() && !this.f1008b.a().g()) {
            setVisibility(8);
            return;
        }
        this.f = this.f1008b.b();
        if (TextUtils.isEmpty(this.f)) {
            this.f = "AdChoices";
        }
        NativeAd.Image adChoicesIcon = this.f1008b.getAdChoicesIcon();
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.AdChoicesView.1
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
                    ...
                    } else if (!TextUtils.isEmpty(AdChoicesView.this.f1008b.getAdChoicesLinkUrl())) {
                        g.a(AdChoicesView.this.f1007a, Uri.parse(AdChoicesView.this.f1008b.getAdChoicesLinkUrl()), nativeAd.h());
                    }
                    return true;
                }
                return false;
        ...
        this.e = new TextView(this.f1007a);
        addView(this.e);
        ...
        if (!z || adChoicesIcon == null) {
            ...
            layoutParams.width = Math.round((adChoicesIcon.getWidth() + 4) * this.f1009c.density);
            layoutParams.height = Math.round((adChoicesIcon.getHeight() + 2) * this.f1009c.density);
            this.d = false;
        }
    ...
    private ImageView a(NativeAd.Image image) {
        ImageView imageView = new ImageView(this.f1007a);
        addView(imageView);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(Math.round(image.getWidth() * this.f1009c.density), Math.round(image.getHeight() * this.f1009c.density));
        layoutParams.addRule(9);
        layoutParams.addRule(15, -1);
        layoutParams.setMargins(Math.round(4.0f * this.f1009c.density), Math.round(this.f1009c.density * 2.0f), Math.round(this.f1009c.density * 2.0f), Math.round(this.f1009c.density * 2.0f));
    ...
    public void a() {
        ...
        int round = Math.round(paint.measureText(this.f) + (4.0f * this.f1009c.density));
