...
public class AudienceNetworkActivity extends Activity {
    ...
    private static final String f1034a = AudienceNetworkActivity.class.getSimpleName();
    ...
    public void b() {
        ...
        xVar.a(new x.a() { // from class: com.facebook.ads.AudienceNetworkActivity.8
            ...
            public void a(y yVar) {
                if (yVar == null || !yVar.a()) {
                    ...
                    AudienceNetworkActivity.this.a(j.REWARD_SERVER_SUCCESS.a());
                }
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void c() {
        String a2 = com.facebook.ads.internal.util.g.a(this.g.getByteArrayExtra(END_CARD_MARKUP));
        if (TextUtils.isEmpty(a2)) {
            return;
        }
        this.d = new c(this, new c.b() { // from class: com.facebook.ads.AudienceNetworkActivity.9
            @Override // com.facebook.ads.internal.view.c.b
            public void a() {
                if (AudienceNetworkActivity.this.d == null || TextUtils.isEmpty(AudienceNetworkActivity.this.f1036c)) {
                    return;
                }
                AudienceNetworkActivity.this.d.post(new Runnable() { // from class: com.facebook.ads.AudienceNetworkActivity.9.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (AudienceNetworkActivity.this.d.c()) {
                            Log.w(AudienceNetworkActivity.f1034a, "Webview already destroyed, cannot activate");
                        } else {
                            AudienceNetworkActivity.this.d.loadUrl("javascript:" + AudienceNetworkActivity.this.f1036c);
                        }
                    }
                });
            }
            ...
            public void a(String str, Map<String, String> map) {
                ...
                a a3 = b.a(AudienceNetworkActivity.this, AudienceNetworkActivity.this.f1035b, parse, map);
                if (a3 != null) {
                    try {
                        a3.b();
                    } catch (Exception e) {
                        Log.e(AudienceNetworkActivity.f1034a, "Error executing action", e);
                    }
                }
            }
        ...
        this.f1036c = this.g.getStringExtra(END_CARD_ACTIVATION_COMMAND);
        this.d.loadDataWithBaseURL(h.a(), a2, WEBVIEW_MIME_TYPE, WEBVIEW_ENCODING, null);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f1035b = this.g.getStringExtra(CLIENT_TOKEN);
        a(this.g, bundle);
        if (this.k == Type.VIDEO) {
            r rVar = new r(this, new d.a() { // from class: com.facebook.ads.AudienceNetworkActivity.2
            ...
            this.o = new l(this, new d.a() { // from class: com.facebook.ads.AudienceNetworkActivity.3
                @Override // com.facebook.ads.internal.view.d.a
                public void a(View view) {
                    AudienceNetworkActivity.this.f.addView(view);
                }
            ...
            this.o = new com.facebook.ads.internal.view.h(this, new d.a() { // from class: com.facebook.ads.AudienceNetworkActivity.5
                @Override // com.facebook.ads.internal.view.d.a
                public void a(View view) {
                    AudienceNetworkActivity.this.f.addView(view);
                    if (AudienceNetworkActivity.this.h != null) {
