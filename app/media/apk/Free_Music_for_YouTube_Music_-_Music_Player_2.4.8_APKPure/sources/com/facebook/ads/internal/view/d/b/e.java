    ...
    public void a_(final com.facebook.ads.internal.view.n nVar) {
        this.d.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.internal.view.d.b.e.1
            ...
            public void onClick(View view) {
                try {
                    nVar.getEventBus().a((r<s, q>) new com.facebook.ads.internal.view.d.a.a(Uri.parse(e.this.f1659c)));
                    com.facebook.ads.internal.util.g.a(e.this.f1658b, Uri.parse(e.this.f1659c), e.this.e);
                } catch (ActivityNotFoundException e) {
                    Log.e("LearnMorePlugin", "Error while opening " + e.this.f1659c, e);
                }
            }
        });
    }
