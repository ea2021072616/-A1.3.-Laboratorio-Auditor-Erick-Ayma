...
class c {
    ...
    public void c() {
        ...
        this.f641a = ((this.d - 1) / 3) + 30;
        byte[] bArr = this.f642b;
        int i2 = this.f643c;
        int i3 = this.f643c / (this.d * 3);
        int i4 = i3 / 100;
        ...
        if (this.f643c < 1509) {
            i = 3;
        } else if (this.f643c % 499 != 0) {
            i = 1497;
        } else if (this.f643c % 491 != 0) {
            i = 1473;
        } else if (this.f643c % 487 != 0) {
            i = 1461;
        } else {
            i = 1509;
        }
        ...
        int i10 = 1024;
        while (i9 < i3) {
            int i11 = (bArr[i6 + 0] & Constants.UNKNOWN) << 4;
            int i12 = (bArr[i6 + 1] & Constants.UNKNOWN) << 4;
            int i13 = (bArr[i6 + 2] & Constants.UNKNOWN) << 4;
            int b2 = b(i11, i12, i13);
            b(i10, b2, i11, i12, i13);
            if (i7 != 0) {
                a(i7, b2, i11, i12, i13);
            }
            int i14 = i6 + i;
            int i15 = i14 >= i2 ? i14 - this.f643c : i14;
            int i16 = i9 + 1;
            int i17 = i4 == 0 ? 1 : i4;
            if (i16 % i17 == 0) {
                int i18 = i10 - (i10 / this.f641a);
                int i19 = i8 - (i8 / 30);
                int i20 = i19 >> 6;
                if (i20 <= 1) {
                    i20 = 0;
