...
public final class it {
    ...
    public final byte[] d() throws IOException {
        ...
        try {
            ...
            dataOutputStream.writeLong(this.f1897a);
            dataOutputStream.writeLong(this.g);
            dataOutputStream.writeBoolean(this.i);
            if (this.i) {
                dataOutputStream.writeShort(this.f1898b);
                dataOutputStream.writeUTF(this.f1899c);
            }
            ...
            if (this.d != null) {
                for (Map.Entry<Long, ip> entry : this.d.entrySet()) {
                    ...
                    Iterator<iq> it = value.f.iterator();
                    while (it.hasNext()) {
                        iq next = it.next();
                        dataOutputStream.writeShort(next.f1879a);
                        dataOutputStream.writeLong(next.f1880b);
                        dataOutputStream.writeLong(next.f1881c);
    ...
    public static class a implements lg<it> {
        ...
        public final /* synthetic */ void a(OutputStream outputStream, it itVar) throws IOException {
            ...
            dataOutputStream.writeLong(itVar2.f1897a);
            ...
            dataOutputStream.writeInt(itVar2.f1898b);
            if (itVar2.f1899c != null) {
                dataOutputStream.writeUTF(itVar2.f1899c);
            } else {
            ...
            this.f1900a.a(outputStream, itVar2.a());
        }
        ...
        public final /* synthetic */ it a(InputStream inputStream) throws IOException {
            ...
            itVar.f = readLong2;
            itVar.f1898b = readInt;
            itVar.j = readInt2;
            itVar.k = new AtomicInteger(readInt3);
            List<ip> a3 = this.f1900a.a(inputStream);
            if (a3 != null) {
                itVar.d = new HashMap();
                for (ip ipVar : a3) {
                    ipVar.g = itVar;
                    itVar.d.put(Long.valueOf(ipVar.f1873a), ipVar);
                }
            }
            return itVar;
        }
