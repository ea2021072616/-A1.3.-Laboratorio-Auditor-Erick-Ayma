...
public class ht {
    ...
    private static final String f1807a = ht.class.getSimpleName();

    public static Map<String, List<String>> a(String str) {
        String[] split;
        km.a(3, f1807a, "Parsing referrer map");
        if (str == null) {
        ...
        for (String str2 : str.split("&")) {
            ...
            if (split2.length != 2) {
                km.a(5, f1807a, "Invalid referrer Element: " + str2 + " in referrer tag " + str);
            } else {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            km.a(3, f1807a, "entry: " + ((String) entry.getKey()) + "=" + entry.getValue());
        }
        ...
        if (sb.length() > 0) {
            km.a(5, f1807a, "Detected missing referrer keys : " + sb.toString());
        }
        return hashMap;
    }
}
