...
class CLSUUID {
    ...
    public CLSUUID(o oVar) {
        byte[] bArr = new byte[10];
        populateTime(bArr);
        populateSequenceNumber(bArr);
        populatePID(bArr);
        String a2 = i.a(oVar.b());
        String a3 = i.a(bArr);
        _clsId = String.format(Locale.US, "%s-%s-%s-%s", a3.substring(0, 12), a3.substring(12, 16), a3.subSequence(16, 20), a2.substring(0, 12)).toUpperCase(Locale.US);
    }
