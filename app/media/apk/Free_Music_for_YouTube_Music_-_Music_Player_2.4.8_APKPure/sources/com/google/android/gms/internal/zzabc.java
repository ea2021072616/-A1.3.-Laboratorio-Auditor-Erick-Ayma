...
public final class zzabc implements Parcelable.Creator<zzaba> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzaba createFromParcel(Parcel parcel) {
    ...
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzaba[] newArray(int i) {
        return new zzaba[i];
    }
}
