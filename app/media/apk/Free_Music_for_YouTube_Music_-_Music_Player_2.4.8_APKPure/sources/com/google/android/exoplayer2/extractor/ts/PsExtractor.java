...
public final class PsExtractor implements Extractor {
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (PACK_START_CODE == (((bArr[0] & Constants.UNKNOWN) << 24) | ((bArr[1] & Constants.UNKNOWN) << 16) | ((bArr[2] & Constants.UNKNOWN) << 8) | (bArr[3] & Constants.UNKNOWN)) && (bArr[4] & 196) == 68 && (bArr[6] & 4) == 4 && (bArr[8] & 4) == 4 && (bArr[9] & 1) == 1 && (bArr[12] & 3) == 3) {
                    ...
                    if (!this.foundAllTracks) {
                        if (pesReader == null) {
                            ...
                            if (elementaryStreamReader != null) {
                                elementaryStreamReader.init(this.output, new ElementaryStreamReader.TrackIdGenerator(i, 256));
