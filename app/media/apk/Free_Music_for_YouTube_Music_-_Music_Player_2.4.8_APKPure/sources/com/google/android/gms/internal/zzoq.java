...
public final class zzoq implements zzrn {
    private /* synthetic */ com.google.android.gms.ads.internal.js.zzai zzbsy;
    private /* synthetic */ zzom zzbsz;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzoq(zzom zzomVar, com.google.android.gms.ads.internal.js.zzai zzaiVar) {
        this.zzbsz = zzomVar;
        this.zzbsy = zzaiVar;
    }
    ...
    public final void zza(zzakk zzakkVar, Map<String, String> map) {
        ...
        if (zzakkVar2 == null) {
            this.zzbsy.zzb("/hideOverlay", this);
        } else if (zzakkVar2 == null) {
            throw null;
        } else {
            ((View) zzakkVar2).setVisibility(8);
        }
    }
}
