...
final class WavHeader {
    ...
    public long getPosition(long j) {
        return Math.min((((this.averageBytesPerSecond * j) / C.MICROS_PER_SECOND) / this.blockAlignment) * this.blockAlignment, this.dataSize - this.blockAlignment) + this.dataStartPosition;
    }

    public long getTimeUs(long j) {
        return (C.MICROS_PER_SECOND * j) / this.averageBytesPerSecond;
    }
