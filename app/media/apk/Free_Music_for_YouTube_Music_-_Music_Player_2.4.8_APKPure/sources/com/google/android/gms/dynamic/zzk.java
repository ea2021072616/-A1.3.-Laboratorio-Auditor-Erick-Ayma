...
public interface zzk extends IInterface {
    ...
    IObjectWrapper zzaob() throws RemoteException;

    zzk zzaoc() throws RemoteException;

    IObjectWrapper zzaod() throws RemoteException;

    zzk zzaoe() throws RemoteException;
