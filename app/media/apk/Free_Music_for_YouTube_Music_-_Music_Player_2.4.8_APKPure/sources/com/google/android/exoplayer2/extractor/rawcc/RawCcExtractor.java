...
public final class RawCcExtractor implements Extractor {
    ...
    private void parseHeader(ExtractorInput extractorInput) throws IOException, InterruptedException {
        this.dataScratch.reset();
        extractorInput.readFully(this.dataScratch.data, 0, 8);
