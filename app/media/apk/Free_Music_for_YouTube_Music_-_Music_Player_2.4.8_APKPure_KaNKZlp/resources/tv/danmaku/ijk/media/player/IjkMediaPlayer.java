...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    // for pili
    public static final int FFP_PROP_INT64_STREAM_GOP_TIME            = 20500;
    public static final int FFP_PROP_INT64_SOURCE_FPS_AUDIO           = 20501;
    public static final int FFP_PROP_INT64_SOURCE_FPS_VIDEO           = 20502;
    public static final int FFP_PROP_INT64_BITRATE_VIDEO              = 20503;
    public static final int FFP_PROP_INT64_BITRATE_AUDIO              = 20504;
    public static final int FFP_PROP_INT64_FRAMES_DROPPED_VIDEO       = 20505;
    public static final int FFP_PROP_INT64_FRAMES_DROPPED_AUDIO       = 20506;
    public static final int FFP_PROP_INT64_RENDER_FPS_AUDIO           = 20507;
    public static final int FFP_PROP_INT64_PKT_TOTAL_SIZE             = 20508;
    //----------------------------------------
    ...
    public long getStreamGopTime() {
        return _getPropertyLong(FFP_PROP_INT64_STREAM_GOP_TIME, 0);
    }

    public long getPktTotalSize() {
        return _getPropertyLong(FFP_PROP_INT64_PKT_TOTAL_SIZE, 0);
    }

    public long getSourcFpsAudio() {
        return _getPropertyLong(FFP_PROP_INT64_SOURCE_FPS_AUDIO, 0);
    }

    public long getSourcFpsVideo() {
        return _getPropertyLong(FFP_PROP_INT64_SOURCE_FPS_VIDEO, 0);
    }

    public long getRenderFpsAudio() {
        return _getPropertyLong(FFP_PROP_INT64_RENDER_FPS_AUDIO, 0);
    }

    public long getBitrateVideo() {
        return _getPropertyLong(FFP_PROP_INT64_BITRATE_VIDEO, 0);
    }

    public long getBufferTimeVideo() {
        return getVideoCachedDuration();
    }

    public long getBufferFrameVideo() {
        return getVideoCachedPackets();
    }

    public long getBitrateAudio() {
        return _getPropertyLong(FFP_PROP_INT64_BITRATE_AUDIO, 0);
    }
    ...
    public long getBufferFrameAudio() {
        return getAudioCachedPackets();
    }

    public long getFramesDroppedVideo() {
        return _getPropertyLong(FFP_PROP_INT64_FRAMES_DROPPED_VIDEO, 0);
    }

    public long getFramesDroppedAudio() {
        return _getPropertyLong(FFP_PROP_INT64_FRAMES_DROPPED_AUDIO, 0);
    }
...
//        DebugLog.ifmt(TAG, "onNativeInvoke %d", what);
    ...
    @AccessedByNative
    private double mAudioPts;
    @AccessedByNative
    private int mAudioChannel;
    @AccessedByNative
    private int mAudioChannelLayout;
    @AccessedByNative
    ...
    @AccessedByNative
    private int mVideoLinesize;
    @AccessedByNative
    private double mVideoPts;
    @AccessedByNative
    private int mVideoFormat;
    @AccessedByNative
    private int mVideoPlane;
    @AccessedByNative
...
//        Log.e(TAG, "set int property: " + property + ",  value:" + value);
        ...
        IjkMediaPlayer player = weakPlayer.get();
        if (player == null)
            throw new IllegalStateException("<null weakPlayer>.setIntProperty()");

        switch (property) {
            case 1:
                player.setAudioSize(value);
                break;
            case 3:
                player.setAudioChannel(value);
                break;
            case 4:
                player.setAudioChannelLayout(value);
                break;
            case 5:
                player.setAudioSampleRate(value);
                break;
            case 6:
                player.setAudioSampleFormat(value);
                break;

            case 7:
                player.setVideoLinesize(value);
                break;
            case 9:
                player.setVideoFormat(value);
                break;
            case 10:
                player.setVideoPlane(value);
                break;
            case 11:
                player.setVideoWidth(value);
                break;
            case 12:
                player.setVideoHeight(value);
                break;
            case 13:
                player.setVideoSarNum(value);
                break;
            case 14:
                player.setVideoSarDen(value);
                break;
        }
    }
...
//        Log.e(TAG, "set double property: " + property + ",  value:" + value);
        ...
        IjkMediaPlayer player = weakPlayer.get();
        if (player == null)
            throw new IllegalStateException("<null weakPlayer>.setDoubleProperty()");

        switch (property) {
            case 2:
                player.setAudioPts(value);
                break;
            case 8:
                player.setVideoPts(value);
                break;
        }
    }
...
//        Log.e(TAG, "set bytearray property: " + property + ",  value:" + value);
        ...
        switch (property) {
            case 15:
                player.setAudioData(value);
                break;
            case 16:
                player.setVideoData(value);
                break;
        }
    }
    ...
    public void setAudioData(byte[] mAudioData) {
    ...
    public void setAudioSize(int mAudioSize) {
        this.mAudioSize = mAudioSize;
    }
    ...
    public void setAudioPts(double mAudioPts) {
        this.mAudioPts = mAudioPts;
    }
    ...
    public int getAudioChannelLayout() {
        return mAudioChannelLayout;
    }

    public void setAudioChannelLayout(int mAudioChannelLayout) {
        this.mAudioChannelLayout = mAudioChannelLayout;
    }
    ...
    public void setAudioSampleFormat(int mAudioSampleFormat) {
        this.mAudioSampleFormat = mAudioSampleFormat;
    }
    ...
    public void setVideoData(byte[] mVideoData) {
        this.mVideoData = mVideoData;
    }

    public int getVideoLinesize() {
        return mVideoLinesize;
    }

    public void setVideoLinesize(int mVideoLinesize) {
        this.mVideoLinesize = mVideoLinesize;
    }
    ...
    public void setVideoPts(double mVideoPts) {
        this.mVideoPts = mVideoPts;
    }
    ...
    public void setVideoFormat(int mVideoFormat) {
        this.mVideoFormat = mVideoFormat;
    }

    public int getVideoPlane() {
        return mVideoPlane;
    }

    public void setVideoPlane(int mVideoPlane) {
        this.mVideoPlane = mVideoPlane;
    }
    ...
    public void setVideoSarNum(int mVideoSarNum) {
        this.mVideoSarNum = mVideoSarNum;
    }

    public void setVideoSarDen(int mVideoSarDen) {
        this.mVideoSarDen = mVideoSarDen;
    }
}
