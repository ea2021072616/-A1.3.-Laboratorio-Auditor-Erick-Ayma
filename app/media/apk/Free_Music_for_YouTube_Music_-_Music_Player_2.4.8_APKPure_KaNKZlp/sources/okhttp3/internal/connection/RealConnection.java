    ...
    */
    public void connect(int r6, int r7, int r8, boolean r9) {
        ...
        Ld:
            ...
            okhttp3.internal.connection.ConnectionSpecSelector r3 = new okhttp3.internal.connection.ConnectionSpecSelector
            r3.<init>(r0)
        ...
        L79:
            r1 = r2
        L7a:
            okhttp3.Route r0 = r5.route     // Catch: java.io.IOException -> L9d
            boolean r0 = r0.requiresTunnel()     // Catch: java.io.IOException -> L9d
            if (r0 == 0) goto L99
            r5.connectTunnel(r6, r7, r8)     // Catch: java.io.IOException -> L9d
        L85:
            r5.establishProtocol(r3)     // Catch: java.io.IOException -> L9d
            okhttp3.internal.http2.Http2Connection r0 = r5.http2Connection
            if (r0 == 0) goto L98
            okhttp3.ConnectionPool r1 = r5.connectionPool
            monitor-enter(r1)
            okhttp3.internal.http2.Http2Connection r0 = r5.http2Connection     // Catch: java.lang.Throwable -> Lca
            int r0 = r0.maxConcurrentStreams()     // Catch: java.lang.Throwable -> Lca
            r5.allocationLimit = r0     // Catch: java.lang.Throwable -> Lca
            monitor-exit(r1)     // Catch: java.lang.Throwable -> Lca
        L98:
            return
        L99:
            r5.connectSocket(r6, r7)     // Catch: java.io.IOException -> L9d
            goto L85
        L9d:
            r0 = move-exception
            ...
            r5.handshake = r2
            r5.protocol = r2
            r5.http2Connection = r2
            if (r1 != 0) goto Lc6
            okhttp3.internal.connection.RouteException r1 = new okhttp3.internal.connection.RouteException
            r1.<init>(r0)
        Lbd:
            if (r9 == 0) goto Lc5
            boolean r0 = r3.connectionFailed(r0)
            if (r0 != 0) goto L7a
        Lc5:
            throw r1
        Lc6:
