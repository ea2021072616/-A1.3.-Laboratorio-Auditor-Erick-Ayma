...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        if (cacheRequest != null && (body = cacheRequest.body()) != null) {
            ...
            final d a2 = l.a(body);
            return response.newBuilder().body(new RealResponseBody(response.headers(), l.a(new s() { // from class: okhttp3.internal.cache.CacheInterceptor.1
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(name) || !value.startsWith(AppEventsConstants.EVENT_PARAM_VALUE_YES)) && (!isEndToEnd(name) || headers2.get(name) == null)) {
