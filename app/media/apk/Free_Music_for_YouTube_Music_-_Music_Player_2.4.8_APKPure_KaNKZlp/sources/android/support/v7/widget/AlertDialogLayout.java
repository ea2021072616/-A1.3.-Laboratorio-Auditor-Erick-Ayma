...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            ...
            i11 = View.combineMeasuredStates(0, view2.getMeasuredState());
        }
        int i12 = 0;
        if (view3 == null) {
            i3 = 0;
        ...
        if (view4 == null || i5 <= 0) {
            ...
            i9 = View.combineMeasuredStates(i6, view4.getMeasuredState());
            i8 = measuredHeight2;
        }
        int i17 = 0;
        ...
        setMeasuredDimension(View.resolveSizeAndState(i17 + getPaddingLeft() + getPaddingRight(), i, i9), View.resolveSizeAndState(i8, i2, 0));
        if (mode2 != 1073741824) {
