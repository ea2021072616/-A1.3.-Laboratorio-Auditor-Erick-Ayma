...
public class LocalPlayListSelectAdapter extends android.widget.BaseAdapter {
    private Context context;
    private List<LocalPlayListModel> data;
    private LayoutInflater mInflater;
    private LocalSongBean musicModel;
    ...
    public LocalPlayListSelectAdapter(Context context, List<LocalPlayListModel> list, LocalSongBean localSongBean) {
        this.context = context;
        this.data = list;
        this.musicModel = localSongBean;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (i > 1) {
            LocalPlayListModel localPlayListModel = this.data.get(i - 2);
            viewHolder.playlistNameTx.setText(localPlayListModel.getName());
            i.c(this.context).a(localPlayListModel.getCover()).a(new e(this.context), new GlideRoundTransform(this.context, 5)).c().d((int) R.mipmap.icon_playlist_default).a(viewHolder.coverImg);
            h.a(localPlayListModel.getId() + "");
        }
        return view;
    }
