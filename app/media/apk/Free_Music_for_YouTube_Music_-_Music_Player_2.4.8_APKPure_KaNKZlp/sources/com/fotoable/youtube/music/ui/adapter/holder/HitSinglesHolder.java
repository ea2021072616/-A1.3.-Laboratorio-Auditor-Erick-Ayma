...
public class HitSinglesHolder extends AbsHomeItemHolder {
    ...
    public class TopAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(this.inflater.inflate(R.layout.view_home_hit_singles_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, final int i) {
            if (this.homeListNewBeen != null) {
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, com.fotoable.youtube.music.util.d.a(86.0f));
                int b2 = w.b(MusicApplication.c());
                if (i <= 3) {
                    layoutParams.width = b2 - com.fotoable.youtube.music.util.d.a(32.0f);
                } else {
                    layoutParams.width = b2;
                }
                viewHolder.rlDetails.setLayoutParams(layoutParams);
                viewHolder.rlDetails.setOnClickListener(new View.OnClickListener(this, homeListNewBean, i) { // from class: com.fotoable.youtube.music.ui.adapter.holder.HitSinglesHolder$TopAdapter$$Lambda$0
                    private final HitSinglesHolder.TopAdapter arg$1;
                    ...
                    public void onClick(View view) {
                        this.arg$1.lambda$onBindViewHolder$0$HitSinglesHolder$TopAdapter(this.arg$2, this.arg$3, view);
                    }
                });
                if (i % 4 == 3) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public final /* synthetic */ void lambda$onBindViewHolder$0$HitSinglesHolder$TopAdapter(HomeListNewBean homeListNewBean, int i, View view) {
            b.b("HitSingle-Click-热门单曲-点击单曲播放", "视频ID", homeListNewBean.getVideoid());
            b.a("HitSingle-Click-热门单曲-点击单曲播放", "视频ID", homeListNewBean.getVideoid());
    ...
    public HitSinglesHolder(View view) {
        super(view);
        this.isShow = false;
        this.context = view.getContext();
        this.tv_all.setOnClickListener(new View.OnClickListener(this) { // from class: com.fotoable.youtube.music.ui.adapter.holder.HitSinglesHolder$$Lambda$0
            private final HitSinglesHolder arg$1;
            ...
            public void onClick(View view2) {
                this.arg$1.lambda$new$0$HitSinglesHolder(view2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void lambda$new$0$HitSinglesHolder(View view) {
        Intent intent = new Intent(this.context, HomeListActivity.class);
        intent.putExtra("EXTRA_TYPE_KEY", 0);
        this.context.startActivity(intent);
        b.b("HitSingle-Click-热门单曲-更多");
        b.a("HitSingle-Click-热门单曲-更多");
    }
