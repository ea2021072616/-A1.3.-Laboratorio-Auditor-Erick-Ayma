...
public class f implements d {
    ...
    private final AudienceNetworkActivity f1730b;

    /* renamed from: c  reason: collision with root package name */
    private final com.facebook.ads.internal.view.a.a f1731c;
    ...
    public f(final AudienceNetworkActivity audienceNetworkActivity, d.a aVar) {
        this.f1730b = audienceNetworkActivity;
        this.f1731c = new com.facebook.ads.internal.view.a.a(audienceNetworkActivity);
        this.f1731c.setId(View.generateViewId());
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(10);
        this.f1731c.setLayoutParams(layoutParams);
        this.f1731c.setListener(new a.InterfaceC0042a() { // from class: com.facebook.ads.internal.view.f.2
            @Override // com.facebook.ads.internal.view.a.a.InterfaceC0042a
            public void a() {
        ...
        layoutParams2.addRule(3, this.f1731c.getId());
        ...
        this.d.setListener(new d.a() { // from class: com.facebook.ads.internal.view.f.3
            ...
            public void a(String str) {
                f.this.j = true;
                f.this.f1731c.setUrl(str);
            }

            @Override // com.facebook.ads.internal.view.a.d.a
            public void b(String str) {
                f.this.f1731c.setTitle(str);
            }
        ...
        layoutParams3.addRule(3, this.f1731c.getId());
    ...
    public void g() {
        ...
        if (this.l) {
            this.l = false;
            com.facebook.ads.internal.g.g.a(this.f1730b).a(this.h, new k.a(this.d.getFirstUrl()).a(this.i).b(this.k).c(this.d.getResponseEndMs()).d(this.d.getDomContentLoadedMs()).e(this.d.getScrollReadyMs()).f(this.d.getLoadFinishMs()).g(System.currentTimeMillis()).a());
        }
    }
    ...
    public void onDestroy() {
        this.f1730b.removeBackButtonInterceptor(this.f);
