...
public class p implements Map<String, String> {
    ...
    public String a() {
        ...
        for (String str : this.f1398a.keySet()) {
            if (sb.length() > 0) {
                sb.append("&");
            }
            sb.append(str);
            String str2 = this.f1398a.get(str);
            if (str2 != null) {
                sb.append("=");
                try {
    ...
    public String get(Object obj) {
        return this.f1398a.get(obj);
    }

    @Override // java.util.Map
    /* renamed from: a */
    public String put(String str, String str2) {
        return this.f1398a.put(str, str2);
    }

    @Override // java.util.Map
    /* renamed from: b */
    public String remove(Object obj) {
        return this.f1398a.remove(obj);
    }
    ...
    public boolean containsKey(Object obj) {
        return this.f1398a.containsKey(obj);
    }

    @Override // java.util.Map
    public boolean containsValue(Object obj) {
        return this.f1398a.containsValue(obj);
    }

    @Override // java.util.Map
    public Set<Map.Entry<String, String>> entrySet() {
        return this.f1398a.entrySet();
    }
