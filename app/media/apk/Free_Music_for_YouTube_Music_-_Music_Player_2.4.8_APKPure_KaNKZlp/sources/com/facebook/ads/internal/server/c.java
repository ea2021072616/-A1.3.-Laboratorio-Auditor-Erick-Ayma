    ...
    private e a(JSONObject jSONObject) {
        ...
        if (jSONObject2.has("ads")) {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                dVar.a(new com.facebook.ads.internal.f.a(jSONObject3.optString("adapter"), jSONObject3.optJSONObject(ShareConstants.WEB_DIALOG_PARAM_DATA), jSONObject3.optJSONArray("trackers")));
            }
        }
        return new e(dVar);
    }
