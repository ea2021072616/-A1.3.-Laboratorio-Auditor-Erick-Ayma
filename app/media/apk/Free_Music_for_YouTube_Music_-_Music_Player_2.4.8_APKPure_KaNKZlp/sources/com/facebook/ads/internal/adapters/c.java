...
public class c extends v implements t {
    ...
    public void a() {
        ...
        this.f = null;
        if (this.f1159b != null) {
            ViewGroup viewGroup2 = (ViewGroup) this.f1159b.getParent();
            if (((viewGroup2 instanceof NativeContentAdView) || (viewGroup2 instanceof NativeAppInstallAdView)) && (viewGroup = (ViewGroup) viewGroup2.getParent()) != null) {
                ...
                a(this.f1159b);
                a(viewGroup2);
                viewGroup.addView(this.f1159b, indexOfChild);
            }
            this.f1159b = null;
        }
        this.e = null;
    ...
    public void a(final Context context, w wVar, com.facebook.ads.internal.g.f fVar, Map<String, Object> map) {
        ...
        if (optJSONArray != null) {
            ...
            for (int i = 0; i < length; i++) {
                try {
                    ...
                    com.facebook.ads.internal.util.g.a(context, com.facebook.ads.internal.util.v.a(D()) + " AN server error");
        ...
        if (z2) {
            builder.forAppInstallAd(new NativeAppInstallAd.OnAppInstallAdLoadedListener() { // from class: com.facebook.ads.internal.adapters.c.1
                ...
                public void onAppInstallAdLoaded(NativeAppInstallAd nativeAppInstallAd) {
                    c.this.f1160c = nativeAppInstallAd;
                    c.this.g = true;
                    ...
                    c.this.i = nativeAppInstallAd.getIcon() != null ? nativeAppInstallAd.getIcon().getUri() : null;
                    if (c.this.d != null) {
                        com.facebook.ads.internal.util.g.a(context, com.facebook.ads.internal.util.v.a(c.this.D()) + " Loaded");
                        c.this.d.a(c.this);
                    }
                }
            });
        ...
        if (z) {
            builder.forContentAd(new NativeContentAd.OnContentAdLoadedListener() { // from class: com.facebook.ads.internal.adapters.c.2
                ...
                public void onContentAdLoaded(NativeContentAd nativeContentAd) {
                    ...
                    c.this.h = (images == null || images.size() <= 0) ? null : images.get(0).getUri();
                    c.this.i = nativeContentAd.getLogo() != null ? nativeContentAd.getLogo().getUri() : null;
                    if (c.this.d != null) {
                        com.facebook.ads.internal.util.g.a(context, com.facebook.ads.internal.util.v.a(c.this.D()) + " Loaded");
                        c.this.d.a(c.this);
                    }
        ...
        builder.withAdListener(new AdListener() { // from class: com.facebook.ads.internal.adapters.c.3
            ...
            public void onAdFailedToLoad(int i2) {
                com.facebook.ads.internal.util.g.a(context, com.facebook.ads.internal.util.v.a(c.this.D()) + " Failed with error code: " + i2);
                if (c.this.d != null) {
                    c.this.d.a(c.this, new AdError(AdError.MEDIATION_ERROR_CODE, "AdMob error code: " + i2));
                }
            }
    ...
    public void a(View view, List<View> list) {
        ...
        while (true) {
            ...
            if (viewGroup3 == null) {
                Log.e(f1158a, "View must have valid parent for AdMob registration, skipping registration. Impressions and clicks will not be logged.");
                return;
            }
            ...
            if (viewGroup != null) {
                NativeAdView nativeContentAdView = this.f1160c instanceof NativeContentAd ? new NativeContentAdView(view.getContext()) : new NativeAppInstallAdView(view.getContext());
                ...
                this.e.setNativeAd(this.f1160c);
    ...
    @Override // com.facebook.ads.internal.adapters.v
    public boolean b() {
        return this.g && this.f1160c != null;
    }
    ...
    public NativeAd.Image l() {
        ...
        return new NativeAd.Image(this.h.toString(), 1200, IjkMediaCodecInfo.RANK_LAST_CHANCE);
    }
