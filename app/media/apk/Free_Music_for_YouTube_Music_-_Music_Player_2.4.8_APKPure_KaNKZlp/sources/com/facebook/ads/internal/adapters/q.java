...
public class q extends v implements t {
    ...
    public void a() {
        if (b()) {
            InMobiNative inMobiNative = this.f1225b;
    ...
    public void a(final Context context, w wVar, com.facebook.ads.internal.g.f fVar, Map<String, Object> map) {
        ...
        this.f1225b = new InMobiNative(valueOf.longValue(), new InMobiNative.NativeAdListener() { // from class: com.facebook.ads.internal.adapters.q.1
            ...
            public void onAdLoadFailed(InMobiNative inMobiNative, InMobiAdRequestStatus inMobiAdRequestStatus) {
                ...
                if (q.this.f1224a != null) {
                    q.this.f1224a.a(q.this, new AdError(AdError.MEDIATION_ERROR_CODE, inMobiAdRequestStatus.getMessage()));
                }
            }
            ...
            public void onAdLoadSucceeded(InMobiNative inMobiNative) {
                try {
                    ...
                    q.this.f1226c = true;
                    if (q.this.d != null) {
                        InMobiNative unused = q.this.f1225b;
    ...
    public void a(View view, List<View> list) {
        ...
        if (b()) {
            InMobiNative inMobiNative = this.f1225b;
            InMobiNative.bind(this.d, this.f1225b);
        }
    }
    ...
    public void b(Map<String, String> map) {
        if (b()) {
            this.f1224a.c(this);
            this.f1225b.reportAdClickAndOpenLandingPage((Map) null);
        }
    }

    @Override // com.facebook.ads.internal.adapters.v
    public boolean b() {
        return this.f1225b != null && this.f1226c;
    }
