...
public class DeviceAuthDialog extends DialogFragment {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void presentConfirmation(final String str, final Utility.PermissionsPair permissionsPair, final String str2, String str3, final Date date, final Date date2) {
    ...
    public void onSuccess(final String str, Long l, Long l2) {
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, date, null, date2), "me", bundle, HttpMethod.GET, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog.7
            @Override // com.facebook.GraphRequest.Callback
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
                    if (graphResponse.getError() != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void completeLogin(String str, Utility.PermissionsPair permissionsPair, String str2, Date date, Date date2) {
