...
public abstract class LoginMethodHandler implements Parcelable {
    ...
    public static AccessToken createAccessTokenFromWebBundle(Collection<String> collection, Bundle bundle, AccessTokenSource accessTokenSource, String str) throws FacebookException {
        ...
        return new AccessToken(string, str, getUserIDFromSignedRequest(bundle.getString("signed_request")), arrayList, arrayList2, accessTokenSource, bundleLongAsDate, new Date(), bundleLongAsDate2);
    }
    ...
    public static String getUserIDFromSignedRequest(String str) throws FacebookException {
        ...
        try {
            ...
            if (split.length == 2) {
                return new JSONObject(new String(Base64.decode(split[1], 0), C.UTF8_NAME)).getString(AccessToken.USER_ID_KEY);
            }
