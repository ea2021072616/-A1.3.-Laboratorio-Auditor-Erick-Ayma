...
public class Crashlytics extends i<Void> implements j {
    ...
    public void setDebugMode(boolean z) {
        c.h().d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        c.h().d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return c.i();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        c.h().d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
