...
public class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<o.a, String> map, int i3, String str3, String str4) throws Exception {
        ByteString copyFromUtf8 = ByteString.copyFromUtf8(str);
    ...
    private static int getSessionAppSize(ByteString byteString, ByteString byteString2, ByteString byteString3, ByteString byteString4, ByteString byteString5, int i, ByteString byteString6) {
        ...
        int computeTagSize = computeBytesSize + sessionAppOrgSize + CodedOutputStream.computeTagSize(5) + CodedOutputStream.computeRawVarint32Size(sessionAppOrgSize) + CodedOutputStream.computeBytesSize(6, byteString5);
        if (byteString6 != null) {
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<o.a, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        int i4;
        ...
        if (map != null) {
            Iterator<Map.Entry<o.a, String>> it = map.entrySet().iterator();
            while (true) {
                i4 = computeBytesSize;
                if (!it.hasNext()) {
                    break;
                }
                Map.Entry<o.a, String> next = it.next();
                int deviceIdentifierSize = getDeviceIdentifierSize(next.getKey(), next.getValue());
                computeBytesSize = deviceIdentifierSize + CodedOutputStream.computeTagSize(11) + CodedOutputStream.computeRawVarint32Size(deviceIdentifierSize) + i4;
            }
        } else {
            i4 = computeBytesSize;
        }
    ...
    private static int getBinaryImageSize(ByteString byteString, ByteString byteString2) {
        int computeUInt64Size = 0 + CodedOutputStream.computeUInt64Size(1, 0L) + CodedOutputStream.computeUInt64Size(2, 0L) + CodedOutputStream.computeBytesSize(3, byteString);
        if (byteString2 != null) {
    ...
    private static int getSessionEventSize(long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, Map<String, String> map, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i2, ByteString byteString, ByteString byteString2, Float f, int i3, boolean z, long j2, long j3, ByteString byteString3) {
        ...
        int computeTagSize2 = eventDeviceSize + CodedOutputStream.computeTagSize(5) + CodedOutputStream.computeRawVarint32Size(eventDeviceSize) + computeTagSize;
        if (byteString3 != null) {
            int eventLogSize = getEventLogSize(byteString3);
            return computeTagSize2 + eventLogSize + CodedOutputStream.computeTagSize(6) + CodedOutputStream.computeRawVarint32Size(eventLogSize);
        }
    ...
    private static int getEventAppSize(TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2, Map<String, String> map, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i2) {
        ...
        if (map != null) {
            ...
            while (true) {
                ...
                computeTagSize = eventAppCustomAttributeSize + CodedOutputStream.computeTagSize(2) + CodedOutputStream.computeRawVarint32Size(eventAppCustomAttributeSize) + i5;
            }
            i3 = i5;
        } else {
            i3 = computeTagSize;
        ...
        if (runningAppProcessInfo != null) {
            i4 = CodedOutputStream.computeBoolSize(3, runningAppProcessInfo.importance != 100) + i3;
        } else {
            i4 = i3;
        }
    ...
    private static int getEventAppExecutionSize(TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2) {
        ...
        int length = threadArr.length;
        int computeTagSize = threadSize + CodedOutputStream.computeTagSize(1) + CodedOutputStream.computeRawVarint32Size(threadSize) + 0;
        for (int i2 = 0; i2 < length; i2++) {
            int threadSize2 = getThreadSize(threadArr[i2], list.get(i2), 0, false);
            computeTagSize += threadSize2 + CodedOutputStream.computeTagSize(1) + CodedOutputStream.computeRawVarint32Size(threadSize2);
        }
        ...
        int computeTagSize2 = eventAppExecutionExceptionSize + CodedOutputStream.computeTagSize(2) + CodedOutputStream.computeRawVarint32Size(eventAppExecutionExceptionSize) + computeTagSize + eventAppExecutionSignalSize + CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeRawVarint32Size(eventAppExecutionSignalSize);
        int binaryImageSize = getBinaryImageSize(byteString, byteString2);
        return computeTagSize2 + binaryImageSize + CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeRawVarint32Size(binaryImageSize);
    }
    ...
    private static int getEventAppExecutionExceptionSize(TrimmedThrowableData trimmedThrowableData, int i, int i2) {
        ...
        if (trimmedThrowableData2 != null) {
            if (i < i2) {
                ...
                return computeBytesSize + eventAppExecutionExceptionSize + CodedOutputStream.computeTagSize(6) + CodedOutputStream.computeRawVarint32Size(eventAppExecutionExceptionSize);
            }
            while (trimmedThrowableData2 != null) {
                trimmedThrowableData2 = trimmedThrowableData2.cause;
                i3++;
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        if (stackTraceElement.isNativeMethod()) {
            computeUInt64Size = CodedOutputStream.computeUInt64Size(1, Math.max(stackTraceElement.getLineNumber(), 0)) + 0;
        } else {
            computeUInt64Size = CodedOutputStream.computeUInt64Size(1, 0L) + 0;
        }
        int computeBytesSize = computeUInt64Size + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(stackTraceElement.getClassName() + "." + stackTraceElement.getMethodName()));
        if (stackTraceElement.getFileName() != null) {
            computeBytesSize += CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(stackTraceElement.getFileName()));
        }
        return CodedOutputStream.computeUInt32Size(5, z ? 2 : 0) + ((stackTraceElement.isNativeMethod() || stackTraceElement.getLineNumber() <= 0) ? computeBytesSize : computeBytesSize + CodedOutputStream.computeUInt64Size(4, stackTraceElement.getLineNumber()));
    }
    ...
    private static int getThreadSize(Thread thread, StackTraceElement[] stackTraceElementArr, int i, boolean z) {
        ...
        for (StackTraceElement stackTraceElement : stackTraceElementArr) {
            ...
            computeUInt32Size += frameSize + CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeRawVarint32Size(frameSize);
        }
