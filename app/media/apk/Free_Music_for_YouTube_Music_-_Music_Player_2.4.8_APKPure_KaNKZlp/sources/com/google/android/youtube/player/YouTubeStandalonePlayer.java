...
public final class YouTubeStandalonePlayer {
    ...
    private static Intent a(Intent intent, Activity activity, String str, int i, boolean z, boolean z2) {
        YouTubeIntents.a(intent, activity).putExtra("developer_key", str).putExtra(AudienceNetworkActivity.AUTOPLAY, z).putExtra("lightbox_mode", z2).putExtra("start_time_millis", i).putExtra("window_has_status_bar", (activity.getWindow().getAttributes().flags & 1024) == 0);
        return intent;
    }
