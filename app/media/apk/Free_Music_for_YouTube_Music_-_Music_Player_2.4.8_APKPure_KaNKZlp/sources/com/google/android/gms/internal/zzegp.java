...
public final class zzegp {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        if (obj != null) {
            if (!(obj instanceof zzego)) {
                stringBuffer2.append(stringBuffer).append(zzrf(str)).append(": ");
                if (obj instanceof String) {
                    String str2 = (String) obj;
                    if (!str2.startsWith("http") && str2.length() > 200) {
                        str2 = String.valueOf(str2.substring(0, 200)).concat("[...]");
                    }
                    stringBuffer2.append("\"").append(zzgk(str2)).append("\"");
    ...
    public static <T extends zzego> String zzd(T t) {
        if (t == null) {
            return "";
        }
    ...
    private static String zzrf(String str) {
        StringBuffer stringBuffer = new StringBuffer();
