...
public final class ConnectionResult extends com.google.android.gms.common.internal.safeparcel.zza {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionResult) {
            ...
            return this.zzezx == connectionResult.zzezx && zzbf.equal(this.mPendingIntent, connectionResult.mPendingIntent) && zzbf.equal(this.zzffa, connectionResult.zzffa);
        }
        return false;
    }
    ...
    public final String toString() {
        return zzbf.zzt(this).zzg("statusCode", getStatusString(this.zzezx)).zzg("resolution", this.mPendingIntent).zzg(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, this.zzffa).toString();
    }
