...
public class Api21ItemDivider extends Divider {
    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        if (spanCount == 1) {
            if (isFirstRaw) {
                rect.set(this.mDividerWidth, this.mDividerHeight, this.mDividerWidth, this.mDividerHeight / 2);
            } else if (isLastRaw) {
                rect.set(this.mDividerWidth, this.mDividerHeight / 2, this.mDividerWidth, this.mDividerHeight);
            } else {
                rect.set(this.mDividerWidth, this.mDividerHeight / 2, this.mDividerWidth, this.mDividerHeight / 2);
            }
        } else if (isFirstRaw && isFirstColumn) {
            rect.set(this.mDividerWidth, this.mDividerHeight, this.mDividerWidth / 2, this.mDividerHeight / 2);
        } else if (isFirstRaw && isLastColumn) {
            rect.set(this.mDividerWidth / 2, this.mDividerHeight, this.mDividerWidth, this.mDividerHeight / 2);
        } else if (isFirstRaw) {
            rect.set(this.mDividerWidth / 2, this.mDividerHeight, this.mDividerWidth / 2, this.mDividerHeight / 2);
        } else if (isLastRaw && isFirstColumn) {
            rect.set(this.mDividerWidth, this.mDividerHeight / 2, this.mDividerWidth / 2, this.mDividerHeight);
        } else if (isLastRaw && isLastColumn) {
            rect.set(this.mDividerWidth / 2, this.mDividerHeight / 2, this.mDividerWidth, this.mDividerHeight);
        } else if (isLastRaw) {
            rect.set(this.mDividerWidth / 2, this.mDividerHeight / 2, this.mDividerWidth / 2, this.mDividerHeight);
        } else if (isFirstColumn) {
            rect.set(this.mDividerWidth, this.mDividerHeight / 2, this.mDividerWidth / 2, this.mDividerHeight / 2);
        } else if (isLastColumn) {
            rect.set(this.mDividerWidth / 2, this.mDividerHeight / 2, this.mDividerWidth, this.mDividerHeight / 2);
        } else {
