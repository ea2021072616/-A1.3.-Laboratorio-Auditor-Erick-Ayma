...
public class AlbumMultipleWrapper extends BasicChoiceAlbumWrapper<AlbumMultipleWrapper, ArrayList<AlbumFile>, String, ArrayList<AlbumFile>> {
    ...
    public final AlbumMultipleWrapper checkedList(ArrayList<AlbumFile> arrayList) {
        this.mChecked = arrayList;
        return this;
    }

    public AlbumMultipleWrapper selectCount(@IntRange(from = 1, to = 2147483647L) int i) {
        this.mLimitCount = i;
        return this;
    }
