...
public class kl<T extends mb> {
    ...
    private static final String f2053a = kl.class.getSimpleName();

    /* renamed from: b  reason: collision with root package name */
    private final kd<Object, T> f2054b = new kd<>();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<T, Object> f2055c = new HashMap<>();
    ...
    private synchronized void c(Object obj, T t) {
        this.f2054b.a((kd<Object, T>) obj, t);
        this.f2055c.put(t, obj);
    }
    ...
    public final synchronized void a(Object obj) {
        if (obj != null) {
            ...
            hashSet.addAll(this.f2054b.a((kd<Object, T>) obj));
    ...
    public final synchronized long b(Object obj) {
        return obj == null ? 0L : this.f2054b.a((kd<Object, T>) obj).size();
    }
    ...
    static /* synthetic */ mb a(Runnable runnable) {
        ...
        km.a(6, f2053a, "Unknown runnable class: " + runnable.getClass().getName());
        return null;
    }
}
