...
class h implements X509TrustManager {
    ...
    private static final X509Certificate[] f201a = new X509Certificate[0];

    /* renamed from: b  reason: collision with root package name */
    private final TrustManager[] f202b;
    ...
    public h(i iVar, g gVar) {
        this.f202b = a(iVar);
        this.f203c = iVar;
        this.d = gVar.getPinCreationTimeInMillis();
    ...
    private TrustManager[] a(i iVar) {
        try {
            ...
            trustManagerFactory.init(iVar.f204a);
    ...
    private void a(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        for (TrustManager trustManager : this.f202b) {
    ...
    private void a(X509Certificate[] x509CertificateArr) throws CertificateException {
        if (this.d != -1 && System.currentTimeMillis() - this.d > 15552000000L) {
            b.a.a.a.c.h().d("Fabric", "Certificate pins are stale, (" + (System.currentTimeMillis() - this.d) + " millis vs 15552000000 millis) falling back to system trust.");
            return;
        }
        for (X509Certificate x509Certificate : a.a(x509CertificateArr, this.f203c)) {
