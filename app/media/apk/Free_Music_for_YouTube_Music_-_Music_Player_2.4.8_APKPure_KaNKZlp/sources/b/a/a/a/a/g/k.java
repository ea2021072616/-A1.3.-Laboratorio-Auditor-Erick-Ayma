...
public class k implements v {
    ...
    public t a(b.a.a.a.a.b.k kVar, JSONObject jSONObject) throws JSONException {
        ...
        return new t(a(kVar, optInt2, jSONObject), a(jSONObject.getJSONObject("app")), e(jSONObject.getJSONObject("session")), f(jSONObject.getJSONObject("prompt")), c(jSONObject.getJSONObject("features")), d(jSONObject.getJSONObject("analytics")), g(jSONObject.getJSONObject(BuildConfig.ARTIFACT_ID)), optInt, optInt2);
    }
    ...
    private f g(JSONObject jSONObject) throws JSONException {
        return new f(jSONObject.optString("update_endpoint", u.f252a), jSONObject.optInt("update_suspend_duration", 3600));
    }
