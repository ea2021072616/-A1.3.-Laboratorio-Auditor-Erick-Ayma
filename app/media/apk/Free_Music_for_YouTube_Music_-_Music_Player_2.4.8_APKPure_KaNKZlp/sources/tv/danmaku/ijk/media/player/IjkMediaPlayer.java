...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static void loadLibrariesOnce(IjkLibLoader ijkLibLoader) {
        synchronized (IjkMediaPlayer.class) {
            if (!mIsLibLoaded) {
                ...
                ijkLibLoader.loadLibrary("pldroidplayer");
                mIsLibLoaded = true;
            }
        }
    }
    ...
    public long getStreamGopTime() {
        return _getPropertyLong(FFP_PROP_INT64_STREAM_GOP_TIME, 0L);
    }

    public long getPktTotalSize() {
        return _getPropertyLong(FFP_PROP_INT64_PKT_TOTAL_SIZE, 0L);
    }

    public long getSourcFpsAudio() {
        return _getPropertyLong(FFP_PROP_INT64_SOURCE_FPS_AUDIO, 0L);
    }

    public long getSourcFpsVideo() {
        return _getPropertyLong(FFP_PROP_INT64_SOURCE_FPS_VIDEO, 0L);
    }

    public long getRenderFpsAudio() {
        return _getPropertyLong(FFP_PROP_INT64_RENDER_FPS_AUDIO, 0L);
    }

    public long getBitrateVideo() {
        return _getPropertyLong(FFP_PROP_INT64_BITRATE_VIDEO, 0L);
    }
    ...
    public long getBitrateAudio() {
        return _getPropertyLong(FFP_PROP_INT64_BITRATE_AUDIO, 0L);
    }
    ...
    public long getFramesDroppedVideo() {
        return _getPropertyLong(FFP_PROP_INT64_FRAMES_DROPPED_VIDEO, 0L);
    }

    public long getFramesDroppedAudio() {
        return _getPropertyLong(FFP_PROP_INT64_FRAMES_DROPPED_AUDIO, 0L);
    }
    ...
    public static void setIntProperty(Object obj, int i, int i2) {
        if (obj == null || !(obj instanceof WeakReference)) {
        ...
        switch (i) {
            case 1:
                ijkMediaPlayer.setAudioSize(i2);
                return;
            case 2:
            case 8:
            default:
                return;
            case 3:
                ijkMediaPlayer.setAudioChannel(i2);
                return;
            case 4:
                ijkMediaPlayer.setAudioChannelLayout(i2);
                return;
            case 5:
                ijkMediaPlayer.setAudioSampleRate(i2);
                return;
            case 6:
                ijkMediaPlayer.setAudioSampleFormat(i2);
                return;
            case 7:
                ijkMediaPlayer.setVideoLinesize(i2);
                return;
            case 9:
                ijkMediaPlayer.setVideoFormat(i2);
                return;
            case 10:
                ijkMediaPlayer.setVideoPlane(i2);
                return;
            case 11:
                ijkMediaPlayer.setVideoWidth(i2);
                return;
            case 12:
                ijkMediaPlayer.setVideoHeight(i2);
                return;
            case 13:
                ijkMediaPlayer.setVideoSarNum(i2);
                return;
            case 14:
                ijkMediaPlayer.setVideoSarDen(i2);
                return;
        }
    }

    public static void setDoubleProperty(Object obj, int i, double d) {
        if (obj == null || !(obj instanceof WeakReference)) {
        ...
        switch (i) {
            case 2:
                ijkMediaPlayer.setAudioPts(d);
                return;
            case 8:
                ijkMediaPlayer.setVideoPts(d);
                return;
            default:
                return;
        }
    ...
    public static void setByteArrayProperty(Object obj, int i, byte[] bArr) {
        if (obj == null || !(obj instanceof WeakReference)) {
            throw new IllegalStateException("<null weakThiz>.setDoubleProperty()");
        }
        IjkMediaPlayer ijkMediaPlayer = (IjkMediaPlayer) ((WeakReference) obj).get();
        ...
        switch (i) {
            case 15:
                ijkMediaPlayer.setAudioData(bArr);
                return;
            case 16:
                ijkMediaPlayer.setVideoData(bArr);
                return;
            default:
                return;
        }
    ...
    public int getVideoLinesize() {
        return this.mVideoLinesize;
    }

    public void setVideoLinesize(int i) {
        this.mVideoLinesize = i;
    }
    ...
    public int getVideoPlane() {
        return this.mVideoPlane;
    }

    public void setVideoPlane(int i) {
        this.mVideoPlane = i;
    }
